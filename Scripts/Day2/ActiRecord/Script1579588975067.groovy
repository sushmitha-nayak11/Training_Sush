...
WebUI.waitForElementPresent(findTestObject('Page_OrangeHRM/b_Admin'), 5)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_Admin'))

WebUI.waitForElementPresent(findTestObject('Page_OrangeHRM/a_User Management'), 5)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_User Management'))

WebUI.waitForElementPresent(findTestObject('Page_OrangeHRM/a_Users'), 5)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Users'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'Smith')
